...
from app.infra.sync.daily_export import build_daily_digest, sign_payload, export_signed_digest
from app.infra.sync.cloud_push import push_digest, enqueue, retry_pending
...
class TestExport:
    def test_export_creates_file(self, rsa_key, tmp_path):
        ...
        day = "2026-09-13"
        fn = export_signed_digest(priv, out_dir=out, day=day,
                                  merchant_id="test", store_name="测试店")
        assert fn.exists()
